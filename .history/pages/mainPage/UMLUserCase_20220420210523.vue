<template>
    <div>
        ...
        <div id="uaw_div" class="bd" style="height:12vh">
            <h2>UAW计算</h2>
            <h3 style="float:left">简单角色个数</h3> <a-input-number style="float:left;margin-left:10px" id="inputNumber" v-model="value" :min="1" :max="10" @change="onChange" />
            <h3 style="float:left;margin-left:10px">简单角色个数</h3> <a-input-number style="float:left;margin-left:10px" id="inputNumber" v-model="value" :min="1" :max="10" @change="onChange" />
            <h3 style="float:left;margin-left:10px">简单角色个数</h3> <a-input-number style="float:left;margin-left:10px" id="inputNumber" v-model="value" :min="1" :max="10" @change="onChange" />
        </div>
